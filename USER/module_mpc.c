...
static MpcConfig g_mpc_cfg =
{
    ...
    {0.0008f, 0.0459f, 0.1813f},
    {
        {130.0f/0.36f, 0.0f, 0.0f},
        {0.0f, 10.0f/0.36f, 0.0f},
        {0.0f, 0.0f, 10.0f/0.25f},
    },
    {
        // R = 3000 跟踪慢
        {0.8343e3f, 0.4333e3f, 0.6722e3f},
        {0.4333e3f, 0.4225e3f, 0.7594e3f},
        {0.6722e3f, 0.7594e3f, 1.4524e3f},
        // R = 100 震荡严重
        // {5.2107e3f,    1.4717e3f,    1.9071e3f},
        // {1.4717e3f,    0.8443e3f,    1.3249e3f},
        // {1.9071e3f,    1.3249e3f,    2.8175e3f},
    },
    5000.0f,
    0.2f
};
